...
namespace Spells
{
    public class MissileBarrage : ISpellScript
    {
        ...
        public void OnSpellPostCast(ISpell spell)
        {
            ...
            var targetPos = GetPointFromUnit(owner, 1225.0f);
    ...
    public class MissileBarrageMissile : ISpellScript
    {
        ...
        public void TargetExecute(ISpell spell, IAttackableUnit target, ISpellMissile missile, ISpellSector sector)
        {
            ...
            var damage = 20 + spell.CastInfo.SpellLevel * 80 + ad + ap;
            target.TakeDamage(owner, damage, DamageType.DAMAGE_TYPE_PHYSICAL, DamageSource.DAMAGE_SOURCE_SPELL, false);

            AddParticleTarget(owner, target, "corki_MissleBarrage_DD_tar.troy", target);
            AddParticleTarget(owner, target, "corki_MissleBarrage_std_tar.troy", target);
            missile.SetToRemove();
