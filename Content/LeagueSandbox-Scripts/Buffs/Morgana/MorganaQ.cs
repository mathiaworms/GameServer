...
namespace Buffs
{
    internal class MorganaQ : IBuffGameScript
    {
        ...
        public void OnActivate(IAttackableUnit unit, IBuff buff, ISpell ownerSpell)
        {
            ...
            buff1 = AddParticleTarget(caster, unit, "DarkBinding_beam.troy", unit);
            buff2 = AddParticleTarget(caster, unit, "DarkBinding_tar.troy", unit);
